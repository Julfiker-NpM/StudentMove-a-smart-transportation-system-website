      ...
      <section className="hero-home flex min-h-[70vh] items-center justify-center rounded-2xl border border-white/10 p-8 text-center">
        <div className="w-full max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <a href="#" className="rounded-lg bg-blue-600 px-5 py-2.5 font-medium text-white hover:bg-blue-700">
              Login
            </a>
            <a href="#" className="rounded-lg bg-slate-100 px-5 py-2.5 font-medium text-slate-800 hover:bg-white">
            Register
            </a>
            ...
            <Link href="/dashboard" className="rounded-lg bg-emerald-500 px-5 py-2.5 font-medium text-white hover:bg-emerald-600">
              Dashboard
            </Link>
          </div>
        </div>
